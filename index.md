...
|---|---|---|
| [Confidence intervals for a process mean](topics/statistical-inference/confidence-interval-for-process-mean/content.md) | Does a sample support the intended 100 cm process mean? | Concept note |
